...
public interface AttendanceSessionCommandUseCase {
     ...
     * @return 취소된 출석 세션
     */
    AttendanceSession cancelSession(Long sessionId, Long userId);
     ...
     * @return 수정된 출석 세션
     */
    AttendanceSession updateSessionTitle(Long sessionId, String newTitle, Long userId);
     ...
     * @return 수정된 출석 세션
     */
    AttendanceSession updateQRValidityMinutes(Long sessionId, Integer newValidityMinutes, Long userId);
     ...
     * @return 생성된 QR 토큰
     */
    QRToken generateQRCode(Long sessionId, Long userId);
