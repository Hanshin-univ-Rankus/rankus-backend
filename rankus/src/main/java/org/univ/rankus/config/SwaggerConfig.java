    ...
    public OpenAPI rankusOpenAPI() {
        return new OpenAPI()
                ...
                .tags(List.of(
                        ...
                        new Tag().name("Lab Members").description("👥 랩실 멤버 조회"),
                        new Tag().name("Lab Member Role Management").description("🎭 랩실 멤버 역할 관리"),
                        new Tag().name("Lab Leadership").description("👑 랩장 위임 관리"),
                        ...
                        new Tag().name("Lab Statistics").description("📈 랩실 통계"),
                        new Tag().name("Lab Comprehensive Statistics").description("📊 랩실 종합 통계"),
                        new Tag().name("Lab Export").description("💾 랩실 데이터 내보내기"),
                        new Tag().name("Lab Attendance Management").description("📋 랩실 출석 관리"),
                        new Tag().name("Lab Attendance Export").description("📥 랩실 출석 내보내기"),
