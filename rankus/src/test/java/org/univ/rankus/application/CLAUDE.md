...
class LabApplicationCommandServiceTest {
    ...
    @Mock private LabApplicationRepositoryPort labApplicationRepositoryPort;
    @Mock private LabRepositoryPort labRepositoryPort;
